...
public class IllegalMemoryAddressBeyondMax extends IllegalArgumentException implements MachineFault {

    public IllegalMemoryAddressBeyondMax() {
    ...
    private Binary id = new Binary() {
        ...
        public int getDecimalValue() {
            return MachineProps.ILLEGAL_MEMORY_ADDRESS_BEYOND_MAX_ID;
        }
