...
public class IllegalMemoryAddressToReservedLocations extends IllegalArgumentException implements MachineFault{

    public IllegalMemoryAddressToReservedLocations() {
    ...
    private Binary id = new Binary() {
        ...
        public int getDecimalValue() {
            return MachineProps.ILLEGAL_MEMORY_ADDRESS_TO_RESERVED_LOCATIONS_ID;
        }
